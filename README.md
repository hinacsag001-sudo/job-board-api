...
Open your PyCharm Terminal or Command Prompt and run:
```bash
git clone [https://github.com/hinacsag001-sudo/YOUR-REPO-NAME.git](https://github.com/hinacsag001-sudo/YOUR-REPO-NAME.git)
cd job-board-api